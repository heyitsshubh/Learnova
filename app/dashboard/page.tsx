...
// Assignment status data for horizontal bar chart
...
// Assignment Status Horizontal Bar Chart component
function AssignmentStatusBarChart() {
  return (
      ...
      <div style={{ width: '100%', height: 140 }}>
        <ResponsiveContainer width="100%" height={100}>
          ...
          >
            ...
            <YAxis dataKey="name" type="category" width={110} tick={{ fontSize: 13, fill: '#374151' }} />
            <Tooltip />
