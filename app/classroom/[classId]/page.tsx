...
export default function MeetPage() {
  ...
  const startingMeetingRef = useRef<boolean>(false);
 ...
 const handleStartLecture = async (meeting: Meeting) => {
  // Synchronous guard: blocks a second call even if it fires before React
  // re-renders the disabled state (e.g. a fast double-click).
  if (startingMeetingRef.current) {
    return;
  }
  ...
  try {
    ...
    try {
      ...
      // Meeting was already started (e.g. by another tab/click) — just proceed to join.
    }
